...
try:
    ...
    img_map_originale = tk.PhotoImage(file="map.png")
...
# Garantit au moins un infecté visible au centre
centre = TAILLE_GRILLE // 2
if grille[(centre, centre)]["etat"] != 2:
    grille[(centre, centre)]["etat"] = 2
    placer_personnage(centre, centre)
    hitbox()
